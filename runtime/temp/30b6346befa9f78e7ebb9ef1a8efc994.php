<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"E:\PYS\mengchong\public/../application/admin\view\bbs\examtopic.html";i:1492834322;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
  ...
  <div class="panel admin-panel">
    ...
    <table class="table table-hover text-center">
      ...
      <?php foreach($topicdata as $val): ?>
        <tr valid="<?php echo $val['tid']; ?>">
          <td><input type="checkbox" name="id[]" value="<?php echo $val['tid']; ?>" />
            <?php echo $val['tid']; ?></td>
          <td><?php echo $val['tuname']; ?></td>
          <td><?php echo $val['topic']; ?></td>
          <td><?php echo $val['tcontents']; ?></td>
      ...
      <?php endforeach; ?>
      <tr>
        <td colspan="8"><div class="pagelist"> <a href="index?page=<?php echo $up; ?>">上一页</a><?php $__FOR_START_15889__=1;$__FOR_END_15889__=count($pageshow)+1;for($i=$__FOR_START_15889__;$i < $__FOR_END_15889__;$i+=1){ ?><a href="index?page=<?php echo $i; ?>"><?php echo $i; ?></a><?php } ?><a href="index?page=<?php echo $down; ?>">下一页</a></div></td>
      </tr>
    </table>
  </div>
</form>
